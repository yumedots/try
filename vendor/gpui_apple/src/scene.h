...
typedef struct Shadow {
  ...
  struct ContentMask_ScaledPixels content_mask;
  struct Hsla color;
  struct Bounds_ScaledPixels element_bounds;
  struct Corners_ScaledPixels element_corner_radii;
  /**
